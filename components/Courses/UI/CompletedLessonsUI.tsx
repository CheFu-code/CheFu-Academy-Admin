                    ...
                    {courses.map((course) => {
                        ...
                        return (
                            <div
                                ...
                                onClick={() =>
                                    router.push(
                                        `/courses/my-courses/course-view/${course.id}`,
                                    )
                                }
                                className="bg-muted/30 hover:bg-gray-100/10 transition border cursor-pointer rounded-xl flex flex-col border-green-500"
                            >
                                {course.banner_image && (
...
export default CompletedLessonsUI;
